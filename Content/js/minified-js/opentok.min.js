 ...
 */
!function (e, t) { "object" == typeof exports && "object" == typeof module ? module.exports = t() : "function" == typeof define && define.amd ? define([], t) : "object" == typeof exports ? exports.OT = t() : e.OT = t() }(window, function () {
    return d = [function (e, t, n) { "use strict"; var o = n(461), r = n(136), a = n(138), i = r(function (r) { var i = {}; return Object.keys(a).forEach(function (e) { var t = a[e].method, n = o("OpenTok:" + r + ":" + e.toLowerCase()); n.log = console[t].bind(console), i[e.toLowerCase()] = n }), i }); i.setLogLevel = function (t) { var n; try { n = window.localStorage.debug } catch (e) { n = "" } var e = Object.keys(a).map(function (e) { return (t >= a[e].priority ? "" : "-") + "(autogen)?OpenTok:*:" + e.toLowerCase() }), r = [].concat(e, (n || "").split(/[\s,]/).filter(function (e) { return -1 === e.indexOf("(autogen)?") })).filter(function (e) { return e }).join(","); o.enable(r) }, e.exports = i }, function (e, t, n) {
        (function (P) {
            /*!
