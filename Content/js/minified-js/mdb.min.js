                                ...
                                for (var A in S)
                                    if ("element" !== A) {
                                        ...
                                        if (1 === m) T = F.endValue;
                                            ...
                                            if (T = F.startValue + E * M(m, h, E), !p && T === F.currentValue) continue
                                        }
        ...
        var w = b.CSS = {
            ...
            setPropertyValue: function (t, i, n, s, a) {
                ...
                if ("scroll" === i) a.container ? a.container["scroll" + a.direction] = n : "Left" === a.direction ? e.scrollTo(n, a.alternateValue) : e.scrollTo(a.alternateValue, n);
                    ...
                    } else o(t) && o(t).isSVG && w.Names.SVGAttribute(i) ? t.setAttribute(i, n) : t.style[r] = n;
    ...
    function () {
        ...
        i.instances = {}, i.Type = function (t, e, n) {
                            ...
                            var u = [],
                                ...
                                f = function (t) {
                                    ...
                                    return n.each(this.datasets, function (t) {
                                        ...
                                        s.push(t.x), a.push(t.y), u.push(n.template(this.options.multiTooltipTemplate, t)), c.push({
            ...
            buildYLabels: function () {
                this.yLabels = [];
                for (var t = w(this.stepValue), e = 0; e <= this.steps; e++) this.yLabels.push(T(this.templateString, {
            ...
            setScaleSize: function () {
                var e, i, n, s, o, r, h, u, c, f, d, p, t = b([this.height / 2 - this.pointLabelFontSize - 5, this.width / 2]),
                    a = this.width,
                    l = 0;
                for (this.ctx.font = Y(this.pointLabelFontSize, this.pointLabelFontStyle, this.pointLabelFontFamily), i = 0; i < this.valuesCount; i++) e = this.getPointPosition(i, t), n = this.ctx.measureText(T(this.templateString, {
                    value: this.labels[i]
    ...
    function (t, e) {
        ...
        function h(t) {
            var e, i, n = {
                ...
                s = t && t.ownerDocument;
            return e = s.documentElement, "undefined" != typeof t.getBoundingClientRect && (n = t.getBoundingClientRect()), i = a(s), {
        ...
        var t = t || {},
            ...
            c = {
                ...
                hide: function (t, e) {
                    e = e || this;
                    for (var i = e.getElementsByClassName("waves-rippling"), n = 0, s = i.length; s > n; n++) d(t, e, i[n])
                }
            },
            f = {
                input: function (t) {
        ...
        return t.init = function (t) {
            ...
            for (var n, s, a = 0, o = t.length; o > a; a++) n = t[a], s = n.tagName.toLowerCase(), -1 !== ["input", "img"].indexOf(s) && (f[s](n), n = n.parentElement), -1 === n.className.indexOf("waves-effect") && (n.className += " waves-effect" + e)
        }, t.ripple = function (t, e) {
            t = l(t);
            var i = t.length;
            if (e = e || {}, e.wait = e.wait || 0, e.position = e.position || null, i)
                for (var n, s, a, o = {}, r = 0, u = {
                    type: "mousedown",
                    button: 1
                }, f = function (t, e) {
                    return function () {
                    ...
                    if (n = t[r], s = e.position || {
                        x: n.clientWidth / 2,
                        y: n.clientHeight / 2
                    }, a = h(n), o.x = a.left + s.x, o.y = a.top + s.y, u.pageX = o.x, u.pageY = o.y, c.show(u, n), e.wait >= 0 && null !== e.wait) {
                        var d = {
                            type: "mouseup",
                            button: 1
                        };
            ...
            for (var e = {
                type: "mouseup",
                button: 1
            }, i = 0, n = t.length; n > i; i++) c.hide(e, t[i])
