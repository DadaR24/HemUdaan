        ...
        success: function (response) {
            ...
            if (response[3].length >= !3) {
                ...
                setTimeout(function () {
                    ...
                    window.location = '/course?LanguageID=1&CourseName=@ViewBag.CourseName';
                }, 5000);
            }
        },
...
function SaveData() {
    ...
    $.ajax({
        url: '/KenKen/SaveKenKenData',//@Url.Action("SaveKenKenData", "KenKen")',
        type: "POST",
        data: { KMID: GlobalKMID, CourseID: CourseID, PractID: GetPractID },
        success: function (data) {

            //if (data[0] == "OK") {
            //    /*Swal.fire("Congrats!", "Record save successfully..", "success");*/
            //    setTimeout(function () {
            //        reset();
            //    }, 3000);
            ...
            //}
            if (data[0] == "RNOTOk") {
                Swal.fire("Congrats!", "You have completed all games....", "success");
                $("#dv_quiz_result").removeClass("hidden");
                $("#dv_mcq_box").addClass("hidden");
                //setTimeout(function () {
...
function SkipData() {
    ...
    // var KemMasterID = KMID;
    $.ajax({
        url: '/KenKen/SaveKenKenDataForSkip',//@Url.Action("SaveKenKenData", "KenKen")',
        type: "POST",
        data: { KMID: GlobalKMID, CourseID: CourseID, PractID: GetPractID },
        success: function (data) {
